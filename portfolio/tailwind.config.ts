  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "glow-green":
          "radial-gradient(ellipse at center, rgba(200,200,200,0.08) 0%, transparent 70%)",
        "hero-gradient":
      ...
      boxShadow: {
        "glow-cyan": "0 0 30px rgba(255,255,255,0.15)",
        "glow-green": "0 0 30px rgba(200,200,200,0.1)",
        "card-hover": "0 8px 40px rgba(255,255,255,0.05), 0 0 0 1px rgba(255,255,255,0.08)",
        "card-base": "0 4px 24px rgba(0,0,0,0.8), 0 0 0 1px rgba(50,50,50,1)",
      },
    },
  },
  plugins: [],
